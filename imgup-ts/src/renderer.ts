...
const uploadLink = document.getElementById('uploadLink') as HTMLElement;
if (!uploadLink) console.error('uploadLink element not found');
const fileSelected = document.getElementById('fileSelected') as HTMLElement;
...
const upscaleBtn = document.getElementById('upscaleBtn') as HTMLElement;
if (!upscaleBtn) console.error('upscaleBtn element not found');
const reselectBtn = document.getElementById('reselectBtn') as HTMLElement;
if (!reselectBtn) console.error('reselectBtn element not found');
const upscaling = document.getElementById('upscaling') as HTMLElement;
...
const upscaledImage = document.getElementById('upscaledImage') as HTMLImageElement;
